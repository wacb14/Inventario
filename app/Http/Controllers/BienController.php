...
class BienController extends Controller
{
    public function index(){
        ...
        if(isset($_GET["busqueda"])){
            ...
            $bienes = DB::select('CALL SP_listarBusquedaBienes(?)',array($busqueda));
        }
        else
            $bienes = DB::select('CALL SP_listarBienesServicio(?,?)',array($inicio, $cantidadReg));           
        return view('bienes/index',['bienes'=>$bienes,'nroPaginas'=>$nroPaginas,'pag'=>$pag]);
    }
