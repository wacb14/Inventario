        ...
        @if(auth()->check())
            @if(auth()->user()->tipo_usuario == 'ADMINISTRADOR')
                <div class="new-item">
                    ...
                    @endphp
                    <a class="btn btn-primary" href="{{route('responsables.print')}}?@php echo 'responsables='.$imprimir;@endphp"><img src="{{asset('icons/printer.svg')}}" alt="imprimir" width="25" height="25"></a>
                </div>
            @endif
        @endif
