    ...
    <form action="{{route('servicios.update',$servicio->idservicio)}}" method="POST">
        <div class="form">
            ...
            <div class="form-center">
                ...
                <label>
                    <input type="hidden" name="idservicio" value="{{old('idservicio',$servicio->idservicio)}}" disabled class="border border-gray-200 rounded-md bg-gray-200 w-full text-sm placeholder-gray-900 p-2 focus:bg-white">
                </label>
                <label>
                    Nombre <br>
